...
self.addEventListener('install', e => { e.waitUntil(caches.open(VERSION).then(c => c.addAll([BASE, BASE+'manifest.webmanifest', BASE+'icons/icon-192.png'])).then(() => self.skipWaiting())); });
